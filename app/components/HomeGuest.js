  ...
  return(
    ...
    <div className="row align-items-center">
      <div className="col-lg-7 py-3 py-md-5">
        ...
        <p className="lead text-muted">Are you sick of short tweets and impersonal “shared” posts that are
          reminiscent of the late 90’s email forwards? We believe getting back to actually writing is the key to
